...
class SentimentConfig(BaseModel):
    ...
    aspect_based_generation: bool = Field(
        default=False,
        description="Whether to define sentiment based on the aspect or not. If False, each aspect will have the same sentiment as the concept."
    )
...
class SentimentStructure(BaseModel):
    ...
    given_text: str = Field(
        title="Given Text",
        description="The text provided as input for generating sentiment data"
    )
