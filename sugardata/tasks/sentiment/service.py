...
def _build_sentiment_config(
        ...
        dimensions=None, aspects=None, examples=None, aspect_based_generation=False,
        **kwargs
    ):
    # Detect language
    if not language:
...
def generate_sentiment_data(
    ...
    config, dimensions, aspects, examples = _build_sentiment_config(
        ...
        dimensions=dimensions, aspects=aspects, examples=examples, aspect_based_generation=aspect_based_generation,
        **kwargs
    )
